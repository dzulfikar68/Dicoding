package com.digitcreativestudio.myalarmmanager;
    ...
    public void onClick(View view) {
        switch (view.getId()){
            ...
            case R.id.btn_repeating_time:
                TimePickerFragment timePickerFragmentRepeating = new TimePickerFragment();
                timePickerFragmentRepeating.show(getSupportFragmentManager(), TIME_PICKER_REPEAT_TAG);
                break;
