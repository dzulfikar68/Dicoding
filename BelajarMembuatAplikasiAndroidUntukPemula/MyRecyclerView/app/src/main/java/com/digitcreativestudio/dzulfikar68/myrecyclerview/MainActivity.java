...
public class MainActivity extends AppCompatActivity {
        ...
        ItemClickSupport.addTo(rvCategory)
                .setOnItemClickListener(new ItemClickSupport.OnItemClickListener() {
                    ...
                    public void onItemClicked(RecyclerView recyclerView, int position, View v) {
                        ...
                        showDetailedPresident(list.get(position));
                    }
                });
    }
    ...
    private void showDetailedPresident(President president){
        Person person = new Person();
        person.setName(president.getName());
        person.setRemarks(president.getRemarks());
        person.setPhoto(president.getPhoto());
        person.setDescription(president.getDescription());
